...
<template>
  <main class="min-h-screen transition-colors duration-300">
    ...
    >
      ...
      >
        <div
          class="w-6 h-6 sm:w-8 sm:h-8 border-3 sm:border-4 border-t-3 sm:border-t-4 rounded-full animate-spin dark:border-gray-700 dark:border-t-[#578FCA] border-gray-200 border-t-[#7091F5]"
